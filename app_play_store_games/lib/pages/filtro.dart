...
class _FiltroPageState extends State<FiltroPage>{
  final camposParaOrdenacao= {
    Games.campo_id: 'Código', Games.campo_nome: 'Preço', Games.campo_descricao: 'Descrição',
    Games.campo_preco: 'Preço', Games.campo_avaliacao: 'Avaliação', Games.campo_imagem: 'Imagem'
  };

  late final SharedPreferences prefs;
  final _descricaoController = TextEditingController();
  String _campoOrdenacao = Games.campo_id;
  ...
  void _carregarSharedPreferences() async {
    ...
    // _prefs = prefs;
    setState(() {
      _campoOrdenacao = prefs.getString(FiltroPage.CHAVE_CAMPO_ORDENACAO) ?? Games.campo_id;
