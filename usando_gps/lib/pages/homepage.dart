    ...
    child: Column(
      children: [
        ...
        ElevatedButton(
            ...
            child: const Text('Obter localização conhecida')
        ),
        ElevatedButton(
            onPressed: _monitorarandoLocalizacao ? _pararMonitoramento :
            _monitorarLocalizacao,
            child: Text(_monitorarandoLocalizacao ? 'Parar monitoramento' : ''
  ...
  Future<bool> _servicoHabilitado() async{
    ...
    if(!servicoHabilitado){
      await _mostrarDialogMensagem('Para utilizar esse serviço, você deverá '
          'habilitar a localização deste dispositivo');
